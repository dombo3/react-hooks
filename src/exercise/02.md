...
JSON.stringify(value, replacer, space) (If the value has a toJSON() method)
...
- Primitives
  ...
  - BigInt type => Error Do not know how to serialize a BigInt
...
JSON.parse(text, revivier)

return value Object, Array, string, number, boolean, or null
